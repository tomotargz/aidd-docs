...
全9章。軸は**「人手の検査に頼らない」**である。1〜2章で前提を作り、3〜4章で人が判断する場所を絞り、5〜7章でその判断を自動化された検査に置き換え、8〜9章で残る制約を扱う。
...
- **中心となる主張**: 人手のレビューは、エージェントが出すコードの量にスケールしない
...
- **扱わないこと**: デプロイツールの比較・選定、組織の承認プロセスそのものの改定
- **節構成**
  1. デプロイを自動化する
