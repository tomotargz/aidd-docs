...
- `curriculum.md` を決定と判断の記録の2部に分ける (branch: process/split-curriculum)
...
（Phase 1 完了後、`foundation/curriculum.md` から展開する）
...
- [ ] `curriculum.md` を「決定」と「判断の記録」の2部に分ける — `foundation/curriculum.md`（PR #6 のレビューで派生）
