...
- [ ] 3章 スモールバッチとコンテキスト
  - [x] アウトライン設計
  - [ ] 1節 大きなタスクは失敗する — ドラフト執筆
  - [ ] 1節 大きなタスクは失敗する — レビュー反映
  - [ ] 2節 タスクを分割する — ドラフト執筆
  - [ ] 2節 タスクを分割する — レビュー反映
  - [ ] 3節 コンテキストを渡す — ドラフト執筆
  - [ ] 3節 コンテキストを渡す — レビュー反映
  - [ ] 4節 文書の品質が出力を決める — ドラフト執筆
  - [ ] 4節 文書の品質が出力を決める — レビュー反映
  - [ ] 5節 デモ: 文書が整ったリポジトリと整っていないリポジトリ — ドラフト執筆
  - [ ] 5節 デモ: 文書が整ったリポジトリと整っていないリポジトリ — レビュー反映
  - [ ] 章の振り返り
- [ ] 4章 人による確認
- [ ] 5章 バージョン管理とテスト自動化
- [ ] 6章 継続的インテグレーション
