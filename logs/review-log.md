...
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | fact | High | 相関を因果として記述 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | fact | High | 引用が主張を支えていない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | fact | High | 出典のない定量的な断定 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | logic | High | 比喩からの導出を根拠として扱っている | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | logic | High | 節の冒頭が立てた問いに本文が答えていない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | logic | High | 前提の一部しか使わずに結論づけている | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | paragraph | High | 段落の要約文が末尾にある | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | paragraph | High | 1段落に複数トピックが混在 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | audience | High | 英文引用に訳がなく根拠が読み取れない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | audience | High | 見出しが本文の結論と逆に読める | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | audience | High | 中心となる一文の具体例がない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | logic | Medium | 比喩と観察の間に橋がない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | logic | Medium | 中心となる主張がまとめから落ちている | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | logic | Medium | アウトラインの根拠が原稿で入れ替わっている | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | fact | Medium | 用語の言い換えに出典がない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | fact | Medium | 同一文書内で用語の定義がずれている | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | fact | Medium | エージェントの挙動を出典なく断定 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | style | Medium | 同一概念に複数の呼び名 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | style | Medium | 和欧文間のスペース | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | style | Medium | 見出し直下の1文が見出しの主張になっていない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | style | Medium | 用語集に未登録の語がある | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | tech-writing | Medium | 指示語の指す先が一意でない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | tech-writing | Medium | 同じ語を1文で2回使用 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | tech-writing | Medium | 動作の主語が抽象名詞 | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | tech-writing | Medium | 日本語として読み下しにくい | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | paragraph | Medium | 段落が短く意味の単位になっていない | 未対応 |
| 2026-09-09 | docs/02-not-just-coding/02-amplifier.md | 2-2 | audience | Medium | 同じ引用の再掲の理由が書かれていない | 未対応 |
